          ...
          <section class="login_content">
            <form>
              ...
              <div class="separator">
                ...
                <div>
                  <font size="5"><i class="fa fa-balance-scale"></i> GM</font>
                  <p>©<h id="footer1"></h> All Rights Reserved.</p>
                  <script>var d = new Date();document.getElementById("footer1").innerHTML = d.getFullYear();</script>
                </div>
              </div>
            </form>
          </section>
